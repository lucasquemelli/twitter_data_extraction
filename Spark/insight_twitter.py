...
if __name__ == "__main__":
    ...
    tweet = spark.read.json(
        "/home/lucasquemelli/datapipeline"
    ...
    tweet = tweet.alias("tweet")\
        ...
        ).groupBy(to_date("created_at").alias("creation_date"))\
        .agg(
        ...
        ).withColumn("weekday", date_format("creation_date", "E"))

    tweet.coalesce(1).write.mode("overwrite").json("/home/lucasquemelli/datapipeline/datalake/gold/twitter_insight_tweet")
