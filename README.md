...
In the twitter dag third version ([*twitter_dag_third_version.py*](https://github.com/lucasquemelli/twitter_data_extraction/blob/main/Airflow/twitter_dag_third_version.py)) file, they are already connected. The Graph and the Tree View of the DAG is below:
